...
class PacketReader
{
    ...
    public delegate void PacketHandler(Packet msg);

    #region 字段
    private ushort m_sendId;
    private ushort m_nodeId;
    private ushort m_firstId;
    private ushort m_secondId;
    private ushort m_msgLen;

    private READ_STATE m_state = READ_STATE.READ_STATE_SENDID;
    private uint m_expectSize = 2;

    private MemoryStream m_stream = new MemoryStream();
    public PacketHandler m_packetHandler = null;
    #endregion
    ...
    public PacketReader(PacketHandler handler) : this()
    {
